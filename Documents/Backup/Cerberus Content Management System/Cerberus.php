...
if ($_GLOBAL_SAFEHTML_STATUS >= 1) {
	...
	include_once "System/Plugin/Safe-HTML/$_GLOBAL_SAFEHTML_DIRECTORY/Safe-HTML.cerb";
...
include_once "System/Plugin/Text-Editor/$_GLOBAL_TEXT_EDITOR_DIRECTORY/Text-Editor.cerb";
...
echo ("
		<CENTER>
			This Web Site Is Powered By:&nbsp;Isaz&nbsp;Technologies&nbsp;|&nbsp;Page Generation Time: " . $_MAIN_PAGE_GENERATION_TOTAL_TIME . " Seconds&nbsp;|&nbsp;");
...
if ($DB->close($_CERBERUS_DATABASE_CONNECTION)) {
			...
			echo ("Missing: $_MAIN_CONFIGURATION_FILE | <A HREF=\"Diagnose.php\" TITLE=\"Diagnostic Script\" TARGET=\"_NEW\">Please Click Here For Diagnostics</A>.");
